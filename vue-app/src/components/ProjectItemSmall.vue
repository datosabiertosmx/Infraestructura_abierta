...
import CanceladoSvg from "../svg/estatus-proyecto/cancelado-svg.vue";
  ...
  export default{
    ...
    computed : {
      ...
      sector(){
        console.log("problem:", this.project.id, this.project.sector, this.translate(this.project.sector) );
          ...
          <div class="col-sm-12 col-md-8">
            ...
            <h5 class="ia_box_inst">
              ...
              <div class="col-sm-4 px-0">
                ...
                <p><a href="#" class="ai_box_link" v-if="project.sector.length > 1">
                  ...
                  {{translate(project.sector)}}</a></p>
							</div>
              <div class="col-sm-4 px-0">
								<h6 class="ai_label_box">TIPO</h6>
								<p><a href="#" class="ai_box_link">
